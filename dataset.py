...
class Dataset(Dataset):
    ...
    def _extract_label_mapping(self, split_path="data\\ucfTrainTestlist"):
        ...
        with open("D:\\Projet dataset\\ia reconnaissancevideo\\Action-Recognition-master\\data\\ucfTrainTestlist\\classInd.txt") as file:
    ...
    def _extract_sequence_paths(
        self, dataset_path, split_path="D:/Projet dataset/ia reconnaissancevideo/Action-Recognition-master/data/ucfTrainTestlist", split_number=1, training=True
    ):
        ...
        split_path = os.path.join("D:/Projet dataset/ia reconnaissancevideo/Action-Recognition-master/data/ucfTrainTestlist", fn)
        with open(split_path) as file:
            lines = file.read().splitlines()
        sequence_paths = []
        for line in lines:
            seq_name = line.split(".avi")[0]
            seqname1=seq_name.split("/")[0]
            seqname2=seq_name.split("/")[1]
            seqname=seqname1+"\\"+seqname2
            sequence_paths += [os.path.join(dataset_path, seqname)]
