...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="D:\\Projet dataset\\ia reconnaissancevideo\\Action-Recognition-master\\data\\UCF-101", help="Path to UCF-101 dataset")
    parser.add_argument("--split_path", type=str, default="D:\\Projet dataset\\ia reconnaissancevideo\\Action-Recognition-master\\data\\ucfTrainTestlist", help="Path to train/test split")
